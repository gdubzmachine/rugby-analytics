...
CSV_PATH = ROOT_DIR / "data" / "six_nations_2024_matches.csv"
COMPETITION_NAME = "Six Nations 2024"
...
def ensure_competition(conn) -> int:
    """
    Ensure a row exists in competitions for 'Six Nations 2024'
    ...
    conn.execute(
        text("""
            ...
            VALUES (:name, '6N 2024', 'international', 'Europe', 'csv_manual')
...
def upsert_matches(engine, df: pd.DataFrame):
    with engine.begin() as conn:
        ...
        print(f"\nUpserting {len(df)} Six Nations 2024 matches...")
    ...
    print("\n Six Nations 2024 match upsert complete.")
